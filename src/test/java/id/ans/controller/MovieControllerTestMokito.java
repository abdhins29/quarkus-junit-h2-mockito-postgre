...
public class MovieControllerTestMokito {
    ...
    void getAll() {
        ...
        Response response = movieController.getAll();
    ...
    void getByIdOK() {
        ...
        Response response = movieController.getById(1L);
        assertNotNull(response);
        assertEquals(Response.Status.OK.getStatusCode(), response.getStatus());
        assertNotNull(response.getEntity());
    ...
    void getByTitleOK() {
        ...
        Response response = movieController.getByTitle("FirstMovie");
        assertNotNull(response);
        assertEquals(Response.Status.OK.getStatusCode(), response.getStatus());
        assertNotNull(response.getEntity());
        Movie entity = (Movie) response.getEntity();
    ...
    void getByCountry() {
        ...
        Response response = movieController.getByCountry("Planet");
        assertNotNull(response);
        assertEquals(Response.Status.OK.getStatusCode(), response.getStatus());
        assertNotNull(response.getEntity());
        List<Movie> entity = (List<Movie>) response.getEntity();
    ...
    void createOK() {
        ...
        Response response = movieController.create(newMovie);
        assertNotNull(response);
    ...
    void updateByIdOK() {
        ...
        Response response = movieController.updateById(1L, updatedMovie);
    ...
    void updateByIdKO() {
        ...
        Response response = movieController.updateById(1L, new Movie());
    ...
    void deleteByIdOK() {
        ...
        Response response = movieController.deleteById(1L);
        assertNotNull(response);
